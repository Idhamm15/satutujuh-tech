...
export default function Page() {
  ...
  return (
    <>
      ...
      />
      <ServiceList
        title="Layanan Jasa IT Infrastructure Kami"
        subtitle="Kami menyediakan layanan IT Infrastructure yang mencakup berbagai aspek pengelolaan infrastruktur IT untuk memastikan sistem Anda tetap optimal dan aman."
        subtitle2="Berikut adalah tiga layanan utama yang kami tawarkan:"
        services={services}
      />
      <ServiceTech
        image="/img/seo/jasa-maintenance-web.webp"
        imageAlt="Teknologi IT Infrastructure"
      ...
      <WhyChooseUs
        ...
        description="Kami adalah tim IT profesional yang berpengalaman dalam menyediakan layanan IT Infrastructure untuk berbagai industri. Berikut alasan mengapa banyak perusahaan mempercayakan kebutuhan teknologi kepada kami."
        reasons={reasons}
      />
      <OurClient/>
      <BasePortfolio/>
